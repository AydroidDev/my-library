package com.ccb.library.core.web;
...
import com.ccb.library.service.article.PhotoService;
/**
 * UEditor文件上传辅助类
 *
 */
public class Uploader {
	...
	public void upload() throws Exception {
		...
		try {
			...
			Photo photo = new Photo(new User(user.id),this.getPhysicalPath(this.url),"static/ueditor/jsp/"+this.url, this.title, DateProvider.DEFAULT.getDate());
	...
	private String getFolder(String path) {
		...
		path += "/" + formater.format(DateProvider.DEFAULT.getDate());
