...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["bold","italic","underline","strikethrough",'|',"forecolor","fontfamily","fontsize","backcolor",'|',"undo","redo",'|',"link","highlightcode","inserttable","emotion","insertimage",'|',"fullscreen","source","preview"]]
